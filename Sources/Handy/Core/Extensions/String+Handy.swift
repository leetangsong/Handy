...
public extension HandyExtension where Base == String{
    ...
    subscript(_ indexs: Range<Int>) -> String {
        let beginIndex = base.index(base.startIndex, offsetBy: indexs.lowerBound)
        let endIndex = base.index(base.startIndex, offsetBy: indexs.upperBound)
    ...
    subscript(_ indexs: PartialRangeFrom<Int>) -> String {
        let beginIndex = base.index(base.startIndex, offsetBy: indexs.lowerBound)
        return String(base[beginIndex..<base.endIndex])
    }
